...
using AngularFinch.Infrastructure.Services;
...
namespace AngularFinch.Web.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomDbContext(this IServiceCollection services)
        {
            ...
            services.AddDbContextPool<ApplicationDbContext>(options =>
            {
                ...
                {
                    options.UseInMemoryDatabase("AngularFinch"); // Takes database name
                }
                else if (useSqLite.ToLower() == "true")
                {
                    var connection = Startup.Configuration["Data:SqlLiteConnectionString"];
                    options.UseSqlite(connection);
                    options.UseSqlite(connection, b => b.MigrationsAssembly("AngularFinch.Web"));
                ...
                else
                {
                    ...
                    options.UseSqlServer(connection, b => b.MigrationsAssembly("AngularFinch.Web"));
                }
