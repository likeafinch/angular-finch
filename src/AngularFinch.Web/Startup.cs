using AngularFinch.Web.Extensions;
using AngularFinch.Web.SignalR;
using AngularFinch.Core.ViewModels;
using AutoMapper;
...
namespace AngularFinch.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                configuration.RootPath = "ClientApp/dist/AngularFinch";
            });

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new Info { Title = "AngularFinch", Version = "v1" });
            ...
            app.UseSpa(spa =>
                      {
                          ...
                          // [1] In AngularFinch.csproj, change the <BuildServerSideRenderer> property
