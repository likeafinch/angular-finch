...
namespace AngularFinch.Infrastructure
{
  ...
  public class DatabaseInitializer : IDatabaseInitializer
  {
        ...
        _context.Cultures.AddRange(
            new Culture
            {
              ...
              Resources = new List<Resource>() {
                            new Resource { Key = "app_title", Value = "AngularFinch" },
                            new Resource { Key = "app_description", Value = "Demo app using ASP.NET and Angular 6" },
                            new Resource { Key = "app_repo_url", Value = "https://github.com/like-a-fox/AngularFinch" },
    ...
    {
      if (await _openIddictApplicationManager.FindByClientIdAsync("AngularFinch") == null)
      {
        var host = configuration["HostUrl"].ToString();

        var descriptor = new OpenIddictApplicationDescriptor
        {
          ClientId = "AngularFinch",
          DisplayName = "AngularFinch",
